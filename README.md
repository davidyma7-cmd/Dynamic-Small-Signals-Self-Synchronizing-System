...
If calculation is based on the entire signal, the user should consider the trade-off using my method.
If calculation is based on only the signal after all signals arrive, my method is applicable. More testing and refinement should always be implemented for better usage.
